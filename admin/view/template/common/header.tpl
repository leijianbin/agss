...
<div id="header">
  <div class="div1">
    <div class="div2"><img src="view/image/logopic.jpg" title="<?php echo $heading_title; ?>" onclick="location = '<?php echo $home; ?>'" /></div>
    <?php if ($logged) { ?>
  ...
  <div id="menu">
    <ul class="left" style="display: none;">
	  ...
	  <li id="pagedata"><a class="top"><?php echo $text_homemanager; ?></a>
        <ul>
          <li><a href="<?php echo $homelayout; ?>"><?php echo $text_homelayout; ?></a></li>
          <li><a href="<?php echo $pagedata; ?>"><?php echo $text_pagedata; ?></a></li>

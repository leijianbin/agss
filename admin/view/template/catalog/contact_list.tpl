          ...
          <tbody>
            ...
            <tr>
              <td style="text-align: center;"><?php if ($contact['selected']) { ?>
                <input type="checkbox" name="selected[]" value="<?php echo $contact['information_id']; ?>" checked="checked" />
                <?php } else { ?>
                <input type="checkbox" name="selected[]" value="<?php echo $contact['information_id']; ?>" />
                <?php } ?></td>
              <td class="left"><?php echo $contact['email']; ?></td>
              <td class="right"><?php echo $contact['phone']; ?></td>

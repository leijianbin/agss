...
(3, '简体中文', 'zh_CN', 'zh_CN.UTF-8,zh_CN,zh-cn,china', 'cn.png', 'zh-CN', 'zh-CN', 2, 1);
...
(40, 'product 11', '', '', '', 970, 5, 'data/iphone_1.jpg', 8, 1, 101.0000, 0, 9, '2009-02-03', 10.00000000, 1, 0.00000000, 0.00000000, 0.00000000, 1, 1, 1, 0, 1, '2009-02-03 21:07:12', '2011-09-30 01:06:53', 2),
...
(383, 0, 'config', 'config_use_ssl', '0', 0),
(382, 0, 'config', 'config_fraud_status_id', '7', 0),
(380, 0, 'config', 'config_fraud_key', '', 0),
(381, 0, 'config', 'config_fraud_score', '', 0),
(379, 0, 'config', 'config_fraud_detection', '0', 0),
(378, 0, 'config', 'config_alert_emails', '', 0),
(27, 0, 'coupon', 'coupon_sort_order', '4', 0),
(28, 0, 'coupon', 'coupon_status', '1', 0),
(377, 0, 'config', 'config_account_mail', '0', 0),
(375, 0, 'config', 'config_smtp_timeout', '5', 0),
...
(376, 0, 'config', 'config_alert_mail', '0', 0),
(374, 0, 'config', 'config_smtp_port', '25', 0),
(372, 0, 'config', 'config_smtp_username', '', 0),
(373, 0, 'config', 'config_smtp_password', '', 0),
(370, 0, 'config', 'config_mail_parameter', '', 0),
(371, 0, 'config', 'config_smtp_host', '', 0),
(368, 0, 'config', 'config_image_cart_height', '47', 0),
(369, 0, 'config', 'config_mail_protocol', 'mail', 0),
(53, 0, 'reward', 'reward_sort_order', '2', 0),
(54, 0, 'reward', 'reward_status', '1', 0),
(367, 0, 'config', 'config_image_cart_width', '47', 0),
...
(366, 0, 'config', 'config_image_wishlist_height', '47', 0),
(365, 0, 'config', 'config_image_wishlist_width', '47', 0),
...
(364, 0, 'config', 'config_image_compare_height', '90', 0),
(363, 0, 'config', 'config_image_compare_width', '90', 0),
(362, 0, 'config', 'config_image_related_height', '80', 0),
(361, 0, 'config', 'config_image_related_width', '80', 0),
(360, 0, 'config', 'config_image_additional_height', '74', 0),
(359, 0, 'config', 'config_image_additional_width', '74', 0),
(358, 0, 'config', 'config_image_product_height', '80', 0),
(357, 0, 'config', 'config_image_product_width', '80', 0),
(356, 0, 'config', 'config_image_popup_height', '500', 0),
(355, 0, 'config', 'config_image_popup_width', '500', 0),
(353, 0, 'config', 'config_image_thumb_width', '228', 0),
(354, 0, 'config', 'config_image_thumb_height', '228', 0),
(352, 0, 'config', 'config_image_category_height', '80', 0),
(351, 0, 'config', 'config_image_category_width', '80', 0),
(350, 0, 'config', 'config_icon', 'data/cart.png', 0),
(349, 0, 'config', 'config_logo', 'data/logo.png', 0),
(348, 0, 'config', 'config_return_status_id', '2', 0),
(347, 0, 'config', 'config_commission', '5', 0),
(346, 0, 'config', 'config_affiliate_id', '0', 0),
(344, 0, 'config', 'config_stock_checkout', '0', 0),
(93, 0, 'voucher', 'voucher_sort_order', '8', 0),
(94, 0, 'voucher', 'voucher_status', '1', 0),
(345, 0, 'config', 'config_stock_status_id', '6', 0),
(343, 0, 'config', 'config_stock_warning', '0', 0),
(342, 0, 'config', 'config_stock_display', '0', 0),
(341, 0, 'config', 'config_complete_status_id', '7', 0),
(340, 0, 'config', 'config_order_status_id', '7', 0),
(339, 0, 'config', 'config_invoice_prefix', 'INV-2012-00', 0),
(102, 0, 'free_checkout', 'free_checkout_status', '1', 0),
(103, 0, 'free_checkout', 'free_checkout_order_status_id', '1', 0),
(338, 0, 'config', 'config_order_edit', '100', 0),
...
(337, 0, 'config', 'config_checkout_id', '0', 0),
(336, 0, 'config', 'config_guest_checkout', '1', 0),
(335, 0, 'config', 'config_cart_weight', '1', 0),
(334, 0, 'config', 'config_account_id', '0', 0),
...
(329, 0, 'config', 'config_vat', '0', 0),
(328, 0, 'config', 'config_tax', '1', 0),
(327, 0, 'config', 'config_voucher_max', '1000', 0),
(326, 0, 'config', 'config_voucher_min', '1', 0),
(325, 0, 'config', 'config_upload_allowed', 'jpg, JPG, jpeg, gif, png, txt', 0),
(324, 0, 'config', 'config_download', '1', 0),
(323, 0, 'config', 'config_review_status', '1', 0),
(322, 0, 'config', 'config_product_count', '0', 0),
(321, 0, 'config', 'config_admin_limit', '20', 0),
(319, 0, 'config', 'config_weight_class_id', '1', 0),
(320, 0, 'config', 'config_catalog_limit', '15', 0),
(318, 0, 'config', 'config_length_class_id', '1', 0),
(317, 0, 'config', 'config_currency_auto', '1', 0),
(316, 0, 'config', 'config_currency', 'USD', 0),
(315, 0, 'config', 'config_admin_language', 'zh_CN', 0),
(314, 0, 'config', 'config_language', 'en', 0),
(313, 0, 'config', 'config_zone_id', '3563', 0),
(312, 0, 'config', 'config_country_id', '222', 0),
(311, 0, 'config', 'config_layout_id', '4', 0),
(310, 0, 'config', 'config_template', 'default', 0),
(309, 0, 'config', 'config_meta_description', 'My Store', 0),
(308, 0, 'config', 'config_title', 'Your Store', 0),
(307, 0, 'config', 'config_fax', '', 0),
(306, 0, 'config', 'config_telephone', '123456789', 0),
(112, 0, 'config', 'config_email', 'your@store.com', 0),
(304, 0, 'config', 'config_address', 'Address 1', 0),
(303, 0, 'config', 'config_owner', 'Your Name', 0),
(302, 0, 'config', 'config_name', 'Your Store', 0),
(385, 0, 'config', 'config_maintenance', '0', 0),
(386, 0, 'config', 'config_encryption', 'ae45c4a035aaad83eb7163e6d7962dfd', 0),
(387, 0, 'config', 'config_compression', '0', 0),
(388, 0, 'config', 'config_error_display', '1', 0),
(389, 0, 'config', 'config_error_log', '1', 0),
(390, 0, 'config', 'config_error_filename', 'error.txt', 0),
(391, 0, 'config', 'config_google_analytics', '', 0);
